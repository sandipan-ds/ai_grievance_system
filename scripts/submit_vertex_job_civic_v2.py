...
JOB_DISPLAY_NAME = f"distilbert-civic-v2-{int(time.time())}"
...
def main():
    ...
    local_script = Path(__file__).resolve().parent / "distilbert_train_civic_v2.py"
    gcs_script_dest = f"{GCS_DATA_DIR}/distilbert_train_civic_v2.py"
    ...
    print(f"\nSubmitting BERT training job: {JOB_DISPLAY_NAME}")
        ...
        worker_pool_specs=[{
            ...
            "container_spec": {
                ...
                "args": [
                    ...
                    "python -u /gcs/ai-grievance-sandi-data/bert_training/civic_v2/distilbert_train_civic_v2.py "
                    "--data-path /gcs/ai-grievance-sandi-data/bert_training/civic_v2/df_final_nlp_bert_v2.joblib "
                    "--output-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/output "
                    "--checkpoint-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/checkpoints"
                ],
            },
        }],
