...
GCS_OUTPUT   = f"{GCS_DATA_DIR}/deberta_v3_output"
GCS_CHECKPOINT_DIR = f"{GCS_DATA_DIR}/deberta_v3_checkpoints"
...
JOB_DISPLAY_NAME = f"deberta-v3-civic-v2-{int(time.time())}"
...
def main():
    ...
    local_script = Path(__file__).resolve().parent / "deberta_v3_train_civic_v2.py"
    gcs_script_dest = f"{GCS_DATA_DIR}/deberta_v3_train_civic_v2.py"
    ...
    print(f"\nSubmitting DeBERTa v3 Base training job: {JOB_DISPLAY_NAME}")
    ...
    # Submit Vertex AI CustomJob with command executing deberta_v3_train_civic_v2.py
        ...
        worker_pool_specs=[{
            ...
            "container_spec": {
                ...
                "args": [
                    ...
                    "python -u /gcs/ai-grievance-sandi-data/bert_training/civic_v2/deberta_v3_train_civic_v2.py "
                    "--data-path /gcs/ai-grievance-sandi-data/bert_training/civic_v2/df_final_nlp_bert_v2.joblib "
                    "--output-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/deberta_v3_output "
                    "--checkpoint-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/deberta_v3_checkpoints"
                ],
            },
        }],
