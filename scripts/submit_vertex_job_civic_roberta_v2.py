...
# Store in the same bert_training/civic_v2 GCS directory under a subfolder
GCS_DATA_DIR = f"{BUCKET_URI}/bert_training/civic_v2"
GCS_OUTPUT   = f"{GCS_DATA_DIR}/roberta_output"
GCS_CHECKPOINT_DIR = f"{GCS_DATA_DIR}/roberta_checkpoints"
...
JOB_DISPLAY_NAME = f"roberta-civic-v2-{int(time.time())}"
...
def main():
    ...
    local_script = Path(__file__).resolve().parent / "roberta_train_civic_v2.py"
    gcs_script_dest = f"{GCS_DATA_DIR}/roberta_train_civic_v2.py"
    ...
    print(f"\nSubmitting RoBERTa training job: {JOB_DISPLAY_NAME}")
    ...
    # Submit Vertex AI CustomJob with command executing roberta_train_civic_v2.py
        ...
        worker_pool_specs=[{
            ...
            "container_spec": {
                ...
                "args": [
                    ...
                    "python -u /gcs/ai-grievance-sandi-data/bert_training/civic_v2/roberta_train_civic_v2.py "
                    "--data-path /gcs/ai-grievance-sandi-data/bert_training/civic_v2/df_final_nlp_bert_v2.joblib "
                    "--output-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/roberta_output "
                    "--checkpoint-dir /gcs/ai-grievance-sandi-data/bert_training/civic_v2/roberta_checkpoints"
                ],
            },
        }],
